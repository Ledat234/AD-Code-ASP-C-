...
namespace TrainingFPTCo.Models.Queries
{
    public class AccountQuery
    {
        ...
        )
        {
            ...
            {
                string sqlQuery = "INSERT INTO [Users] ([RolesId], [Username], [Password],[ExtraCode], [Email], [Phone], [Address],[FullName],[FistName],[LastName],[Birthday],[Gender], [CreatedAt]) VALUES  (@RoleId, @Username, @Password, @ExtraCode, @Email, @Phone,@Address,@FullName,@FistName,@LastName,@Birthday,@Gender, @CreatedAt); SELECT SCOPE_IDENTITY()";
            ...
            using (SqlConnection connection = Database.GetSqlConnection())
            {
                ...
                using (SqlDataReader reader = cmd.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        detail.FistName = reader["FistName"].ToString();
           ...
           )
        {
            ...
            using (SqlConnection connection = Database.GetSqlConnection())
            {
                string sql = "UPDATE [Users] SET [RolesId] = @RoleId, [UserName] = @UserName, [Password] = @Password, [ExtraCode] = @ExtraCode, [Email] = @Email, [Phone] = @Phone, [Address] = @Address, [FullName] = @FullName, [FistName] = @FistName, [LastName] = @LastName, [Birthday] = @Birthday, [Gender] = @Gender, [UpdatedAt] = @UpdatedAt WHERE [Id] = @Id AND [DeletedAt] IS NULL";
